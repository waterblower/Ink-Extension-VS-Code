...
const getContextInfoAtPosition = (
    document: {
        getWordRangeAtPosition: (arg0: any, arg1: RegExp) => any;
        getText: (arg0: any) => any;
        lineAt: (arg0: any) => { (): any; new (): any; text: any };
    },
    position: { line: any },
) => {
...
const siblingFiles = (docPath: any) =>
    collectInkFiles(findRootInkFile(docPath));
...
const completionProvider = {
    provideCompletionItems(
        document: {
            lineAt: (arg0: any) => { (): any; new (): any; text: string };
            fileName: any;
        },
        position: { character: any },
    ) {
...
const foldingProvider = {
    provideFoldingRanges(
        document: {
            lineCount: number;
            lineAt: (arg0: number) => { (): any; new (): any; text: string };
        },
    ) {
        const ranges = [];
...
const symbolProvider = {
    provideDocumentSymbols(
        document: {
            lineCount: number;
            lineAt: (arg0: number) => { (): any; new (): any; text: any };
        },
    ) {
        const symbols = [];
        let currentKnot = null;
...
const hoverProvider = {
    provideHover(
        ...
        position: { line: number; character: any },
    ) {
        const lineText = document.lineAt(position.line).text;
...
const documentHighlightProvider = {
    provideDocumentHighlights(
        ...
        position: { line: any; character: string | number },
    ) {
...
const activate = async (
    context: { extensionUri: Uri; subscriptions: Disposable[] },
) => {
